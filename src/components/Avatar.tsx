...
export const Avatar: React.FC<AvatarProps> = ({ level, experience, currentAvatarId, onAvatarChange }) => {
  ...
  return (
    <>
      <div 
        className="bg-white/90 p-6 rounded-xl shadow-md text-center backdrop-blur-sm cursor-pointer"
